...
@section('extra-styles')
    <style>
        ...
        .col-btn.auto-active {
            ...
            color: var(--ok-text);
            background: rgba(10, 153, 88, 0.08);
        }
     ...
     */
        .camera-grid {
            ...
            gap: var(--gap);
            flex: 1;
            /* stretch to fill remaining height in flex column */
            min-height: 0;
            align-content: start;
            /* don't stretch rows beyond their natural 16:9 size */
        }
        ...
        .camera-card.offline {
            border-color: rgba(192, 21, 48, 0.35);
        }
        ...
        [data-theme="dark"] .camera-card:hover::after {
            opacity: 1;
        }
     ...
     */
        ...
        .camera-feed img {
            ...
            height: 100%;
            object-fit: contain;
            /* CONTAIN = source ratio always respected, never cropped */
        }
        ...
        .camera-grid[data-cols="6"] .cam-meta {
            display: none;
        }
...
@section('scripts')
    <script>
        ...
        function setRefreshRate(ms) {
            ...
            if (autoRefresh) startAutoRefresh(); // restart timers with new interval
        }
